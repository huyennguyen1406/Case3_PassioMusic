            ...
            <nav class="sidebar-nav">
                <ul id="sidebarnav">
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link waves-effect waves-dark sidebar-link" href=""/home?action=getProfileSinger&idSinger=${id}&userName=${userName}&password=${password}""
                           aria-expanded="false">
                        ...
                        <div class="card-body">
                            <form class="form-horizontal form-material">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="col-md-12 border-bottom p-0">
                                        <input type="text" name="phoneNumber" value="${phoneNumber}" class="form-control p-0 border-0">
                                    </div>
                                </div>
                                <div class="form-group mb-4">
...
<%--                                <div class="form-group mb-4">--%>
<%--                                    <div class="col-sm-12">--%>
<%--                                        <button class="btn btn-success"><b>Update Profile</b></button>&emsp;--%>
<%--                                        <button class="btn btn-danger"><b>    Logout    </b></button>--%>
<%--                                    </div>--%>
...
<%--                                </div>--%>
                            ...
                            <div class="form-group mb-4">
                                <div class="col-sm-12">
                                    <button onclick="location.href='/home?action=updateInformation&idSinger=${id}" class="btn btn-success"><b>Update Profile</b></button>&emsp;
                                    <button onclick="location.href='/home?action=getProfileSinger&idSinger=${id}'" class="btn btn-danger"><b>    Logout    </b></button>
                                </div>
                                <%--                                    <div class="col-sm-12">--%>
                                <%--                                        --%>
                                <%--                                    </div>--%>
